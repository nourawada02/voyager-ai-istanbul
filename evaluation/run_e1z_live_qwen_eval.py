"""Final Evaluation Checkpoint E.1Z -- runs the frozen 30-case supervisor-
only validation manifest (`evaluation/e1z_cases.json`) against the REAL,
...
One-shot: refuses to run if `e1z_live_qwen_results.jsonl` already exists
non-empty.
...
Writes:
    evaluation/e1z_live_qwen_results.jsonl
    evaluation/e1z_live_qwen_summary.json
"""
...
RESULTS_PATH = Path(__file__).parent / "e1z_live_qwen_results.jsonl"
SUMMARY_PATH = Path(__file__).parent / "e1z_live_qwen_summary.json"
